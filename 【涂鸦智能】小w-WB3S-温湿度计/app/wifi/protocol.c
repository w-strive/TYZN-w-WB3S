...
void all_data_update(void)
{
 //   #error "请在此处理可下发可上报数据及只上报数据示例,处理完成后删除该行"
    ...
    mcu_dp_bool_update(DPID_TAMPER_ALARM,当前防拆报警); //BOOL型数据上报;
    mcu_dp_value_update(DPID_TEMP_SAMPLING,当前温度采样时间设置); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUMIDITY_SAMPLING,当前湿度采样时间设置); //VALUE型数据上报;
    ...
    mcu_dp_enum_update(DPID_TEMP_ALARM,当前温度报警); //枚举型数据上报;
    mcu_dp_enum_update(DPID_HUM_ALARM,当前湿度报警); //枚举型数据上报;
    ...
    mcu_dp_value_update(DPID_TEMP_SENSITIVITY,当前温度灵敏度); //VALUE型数据上报;
    mcu_dp_value_update(DPID_HUM_SENSITIVITY,当前湿度灵敏度); //VALUE型数据上报;
...
******************************************************************************/
/*****************************************************************************
函数名称 : dp_download_temp_sampling_handle
功能描述 : 针对DPID_TEMP_SAMPLING的处理函数
输入参数 : value:数据源数据
        : length:数据长度
...
/*****************************************************************************
函数名称 : dp_download_humidity_sampling_handle
功能描述 : 针对DPID_HUMIDITY_SAMPLING的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_temp_periodic_report_handle
功能描述 : 针对DPID_TEMP_PERIODIC_REPORT的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_hum_periodic_report_handle
功能描述 : 针对DPID_HUM_PERIODIC_REPORT的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_temp_sensitivity_handle
功能描述 : 针对DPID_TEMP_SENSITIVITY的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
...
/*****************************************************************************
函数名称 : dp_download_hum_sensitivity_handle
功能描述 : 针对DPID_HUM_SENSITIVITY的处理函数
输入参数 : value:数据源数据
        : length:数据长度
返回参数 : 成功返回:SUCCESS/失败返回:ERROR
使用说明 : 可下发可上报类型,需要在处理完数据后上报处理结果至app
