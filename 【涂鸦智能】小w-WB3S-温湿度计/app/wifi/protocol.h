...
/******************************************************************************
                       1:修改产品信息
******************************************************************************/
#define PRODUCT_KEY "u9zelzbvypciejha"    //开发平台创建产品后生成的16位字符产品唯一标识
...
//防拆报警(只上报)
//备注:
#define DPID_TAMPER_ALARM 5
//温度采样时间设置(可下发可上报)
//备注:
#define DPID_TEMP_SAMPLING 6
//湿度采样时间设置(可下发可上报)
//备注:
#define DPID_HUMIDITY_SAMPLING 7
//充电状态(只上报)
//备注:
...
//当前亮度值(可下发可上报)
//备注:
#define DPID_BRIGHT_VALUE 16
//温度周期上报(可下发可上报)
//备注:
#define DPID_TEMP_PERIODIC_REPORT 17
//湿度周期上报(可下发可上报)
//备注:
#define DPID_HUM_PERIODIC_REPORT 18
//温度灵敏度(可下发可上报)
//备注:
